        ...
        <div className="w-full px-4">
          <div className="relative mx-auto max-w-[525px] overflow-hidden rounded-lg bg-white py-16 px-10 text-center sm:px-12 md:px-[60px]">
            ...
            <form>
              ...
              <div className="mb-10">
                <button
                  className="border-violet-600 w-full cursor-pointer rounded-md border bg-violet-600 py-3 px-5 text-base text-white transition hover:bg-opacity-90"
                  type="submit"
                >
                  Sign Up
                </button>
  ...
  return (
    <div className="mb-6">
      <input
        ...
        name={name}
        className="border-[#E9EDF4] w-full rounded-md border bg-[#FCFDFE] py-3 px-5 text-base text-body-color placeholder-[#ACB6BE] outline-none focus:border-violet-600 focus-visible:shadow-none"
      />
    </div>
  );
};
