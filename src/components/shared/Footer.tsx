        ...
        <div className="container mx-auto">
          <div className="flex flex-wrap -mx-4">
            ...
            <LinkGroup header="Resources">
              <NavLink link="/saasDevelopment" label="SaaS Development" />
              <NavLink link="/ourProducts" label="Our Products" />
              <NavLink link="/userFlow" label="User Flow" />
            ...
            <LinkGroup header="Quick Links">
              <NavLink link="/premium" label="Premium Support" />
            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
              <div className="w-full mb-10">
                <h4 className="text-lg font-semibold mb-9 text-black">
                  Follow us On
                </h4>
...
const LinkGroup = ({ children, header }: ILinkGroupProps) => {
  return (
    <>
      <div className="w-full px-4 sm:w-1/2 lg:w-2/12">
        <div className="w-full mb-10">
          <h4 className="text-lg font-semibold mb-9 text-black"> {header} </h4>
          <ul>{children}</ul>
        </div>
      </div>
    </>
